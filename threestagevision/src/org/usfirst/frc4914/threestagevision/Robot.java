...
public class Robot extends IterativeRobot {
    ...
    NIVision.Range GOAL_HUE_RANGE = new NIVision.Range(0, 255);	//Default hue range for yellow goal
	NIVision.Range GOAL_SAT_RANGE = new NIVision.Range(0, 255);	//Default saturation range for yellow goal
	NIVision.Range GOAL_VAL_RANGE = new NIVision.Range(197, 255);	//Default value range for yellow goal
        ...
        */
        ...
        if (false) {    
    		...
    		if(numParticles > 0)
    		{
    			...
    			SmartDashboard.putNumber("vertCentre", currentGoalVertCentre);
	...
	public static double getCurrentGoalHorCentre() {
    	return table.getNumber("cX", -1);
	}
	
	public static double getCurrentGoalVertCentre() {
    	return table.getNumber("cY", -1);
	}
	
	public static void resetGoalValues() {
		currentGoalHorCentre = 0;
		currentGoalVertCentre = 0;
	}
