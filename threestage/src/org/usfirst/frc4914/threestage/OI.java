...
public class OI {
    ...
    public double driverLJ() { return driverController.getRawAxis(5); }
    public double driverRJ() { return driverController.getRawAxis(1); }
    public double driverLT() { return driverController.getRawAxis(2); }
    public double driverRT() { return driverController.getRawAxis(3); }
    // codriver controller joysticks
    public double codriverX() { return codriverController.getRawAxis(0); }
    public double codriverY() { return codriverController.getRawAxis(1); }
    public double codriverZ() { return codriverController.getRawAxis(2) * 0.5; }
}
