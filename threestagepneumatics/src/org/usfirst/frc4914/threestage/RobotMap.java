...
public class RobotMap {
    ...
    public static SpeedController motorizedArmSlaveMotor;
    public static CANTalon motorizedArmMasterMotor;
    ...
    public static void init() {
        ...
        armCompressor = new Compressor(2);
        
        armDoubleSolenoid = new DoubleSolenoid(2, 1, 0);
        LiveWindow.addActuator("Arm", "Double Solenoid", armDoubleSolenoid);
        
        motorizedArmSlaveMotor = new VictorSP(5);
        LiveWindow.addActuator("Motorized Arm", "Slave Motor", (VictorSP) motorizedArmSlaveMotor);
        
        motorizedArmMasterMotor = new CANTalon(1);
        LiveWindow.addActuator("Motorized Arm", "Master Motor", motorizedArmMasterMotor);
